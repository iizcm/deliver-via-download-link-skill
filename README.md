...
| Field | Value |
| --- | --- |
| **Name** | `deliver-via-download-link-skill` |
...
cp -r productivity/deliver-via-download-link ~/.hermes/skills/productivity/deliver-via-download-link/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/deliver-via-download-link-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/deliver-via-download-link-skill.git ~/.hermes/skills/productivity/deliver-via-download-link/
```
...
```text
skill_view(name="productivity/deliver-via-download-link")
```
...
```text
Use the deliver via download link skill to <describe your specific task here>
```
...
```text
Gunakan skill deliver via download link untuk <deskripsikan tugas spesifik Anda di sini>
```
